...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b36458, const void *arg_0xb7b365f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7ae78c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7991840), 
int (*key_eq_fn)(void *arg_0xb7991c88, void *arg_0xb7991e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78609b8, int arg_0xb7860b10);
static double RandomUniform(void );
...
typedef uint16_t sendAckC$Read$val_t;
...
static void sendAckC$SplitControl$startDone(error_t error);
#line 138
static void sendAckC$SplitControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void sendAckC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void sendAckC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void sendAckC$Read$readDone(error_t result, sendAckC$Read$val_t val);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
static void sendAckC$MilliTimer$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*sendAckAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t /*sendAckAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t sendAckC$SplitControl$start(void );
#line 130
static error_t sendAckC$SplitControl$stop(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t sendAckC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
static uint8_t sendAckC$Packet$payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
uint8_t len);
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t sendAckC$Read$read(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$MilliTimer$startPeriodic(uint32_t dt);
#line 78
static void sendAckC$MilliTimer$stop(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t sendAckC$PacketAcknowledgements$requestAck(
#line 53
message_t * msg);
#line 85
static bool sendAckC$PacketAcknowledgements$wasAcked(
#line 80
message_t * msg);
# 37 "sendAckC.nc"
uint8_t sendAckC$last_digit[1000];
uint8_t sendAckC$counter[1000];
uint8_t sendAckC$acks[1000];
bool sendAckC$locked[1000];
message_t sendAckC$packet[1000];

static void sendAckC$sendReq(void );
static inline void sendAckC$sendResp(void );
...
static inline void sendAckC$sendResp(void );
#line 91
static inline void sendAckC$Boot$booted(void );





static inline void sendAckC$SplitControl$startDone(error_t err);
#line 110
static inline void sendAckC$SplitControl$stopDone(error_t err);




static inline void sendAckC$MilliTimer$fired(void );
#line 129
static void sendAckC$AMSend$sendDone(message_t *buf, error_t err);
#line 168
static inline message_t *sendAckC$Receive$receive(message_t *buf, void *payload, uint8_t len);
#line 215
static inline void sendAckC$Read$readDone(error_t result, uint16_t data);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline void /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
enum /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4333 {
#line 126
...
#line 57
#line 55
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4335 {
  message_t * msg;
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*sendAckAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt);
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*sendAckAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt){
#line 73
...
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static error_t sendAckC$Read$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*sendAckAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read();
#line 55
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static uint8_t sendAckC$Packet$payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 168
{
  ...
  if (len != sizeof(my_msg_t )) {
  ...
  else 
    {
      ...
      sim_log_debug(160U, "radio_rec", "Received packet at time %s at mote %hu\n", sim_time_string(), TOS_NODE_ID);
      sim_log_debug(161U, "radio_pack", ">>>Pack \n \t Payload length %hhu \n", sendAckC$Packet$payloadLength(buf));

      sim_log_debug_clear(162U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(163U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint8(rcm->msg_type.nxdata));
      sim_log_debug_clear(164U, "radio_pack", "\t\t msg_counter: %hhu \n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata));
      sim_log_debug_clear(165U, "radio_pack", "\t\t msg_value: %hhu \n", __nesc_ntoh_uint16(rcm->msg_value.nxdata));

      sendAckC$counter[sim_node()] = __nesc_ntoh_uint16(rcm->msg_counter.nxdata);
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7604ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7604ac8) {
#line 78
    case 6:
#line 78
      __nesc_result = sendAckC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7604ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7601178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7601178, msg, payload, len);
#line 78
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$MilliTimer$startPeriodic(uint32_t dt){
#line 64
...
#line 97
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(151U, "radio", "Radio on on node %d!\n", TOS_NODE_ID);

      if (TOS_NODE_ID == 1) {
          sendAckC$MilliTimer$startPeriodic(1000);
        }
    }
}
...
#line 113
  sendAckC$SplitControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 110
{
  sim_log_debug(152U, "boot", "Radio stopped!\n");
}
...
#line 138
  sendAckC$SplitControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7604108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7604108, msg, error);
#line 110
}
#line 110
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  sendAckC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb749e8a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb749e8a8) {
#line 100
    case 0U:
#line 100
      /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb749e8a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77bc650){
#line 75
  switch (arg_0xb77bc650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77bc650);
#line 75
      break;
#line 75
    }
...
#line 115
{
  ...
  sendAckC$counter[sim_node()]++;
  sim_log_debug(153U, "timer", "Mote %hu, Timer fired, counter is %hu.\n", TOS_NODE_ID, sendAckC$counter[sim_node()]);

  if (sendAckC$locked[sim_node()]) {
#line 122
      return;
    }
  sendAckC$sendReq();
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t /*sendAckAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 52
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t sendAckC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 128 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
static inline error_t TossimPacketModelC$PacketAcknowledgements$requestAck(message_t *msg)
#line 128
{
  tossim_metadata_t *meta = TossimPacketModelC$getMetadata(msg);
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t sendAckC$PacketAcknowledgements$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
inline static void * sendAckC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 215
{
  ...
  my_msg_t *rcm = (my_msg_t *)sendAckC$Packet$getPayload(&sendAckC$packet[sim_node()], sizeof(my_msg_t ));

  double value = (double )data / 65535 * 100;

#line 228
  sim_log_debug(166U, "value", "value read done %f\n", value);

  if (rcm == (void *)0 || sendAckC$locked[sim_node()]) {
      return;
    }
  else {
      __nesc_hton_uint8(rcm->msg_type.nxdata, 2);
      __nesc_hton_uint16(rcm->msg_counter.nxdata, sendAckC$counter[sim_node()]);
      __nesc_hton_uint16(rcm->msg_value.nxdata, value);

      if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) != SUCCESS) {
#line 238
          return;
        }
      if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(167U, "radio_send", "Sending packet RESP from mote 2 to mote 1");
          sendAckC$locked[sim_node()] = TRUE;
          sim_log_debug_clear(168U, "radio_send", " at time %s \n", sim_time_string());
        }
    }
}
...
#line 63
  sendAckC$Read$readDone(result, val);
#line 63
}
#line 63
# 24 "FakeSensorP.nc"
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb731d3a8){
#line 83
  switch (arg_0xb731d3a8) {
#line 83
    case 0U:
#line 83
      sendAckC$MilliTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      /*sendAckAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb731d3a8);
#line 83
      break;
#line 83
    }
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb749d2b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb749d2b0, addr, msg, len);
#line 80
...
#line 147
# 181 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$Packet$setPayloadLength(message_t *msg, uint8_t len)
#line 181
{
...
#line 91
{
  ...
  sim_log_debug(169U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(170U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(171U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(172U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}

# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*sendAckAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static bool sendAckC$PacketAcknowledgements$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
# 78 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$MilliTimer$stop(void ){
#line 78
...
#line 67
# 115 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
static inline error_t TossimPacketModelC$Control$stop(void )
#line 115
{
  if (!TossimPacketModelC$initialized[sim_node()]) {
...
inline static error_t sendAckC$SplitControl$stop(void ){
#line 130
  unsigned char __nesc_result;
#line 130
...
#line 577
{
  sim_log_debug(200U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(199U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(196U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(197U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(189U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(179U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(186U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(191U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t sendAckC$SplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 91
{
  sim_log_debug(150U, "boot", "Application booted.\n");
  sendAckC$SplitControl$start();
}

# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
inline static void SimMainP$Boot$booted(void ){
#line 60
  sendAckC$Boot$booted();
#line 60
}
#line 60
...
#line 285
  ...
  sim_log_debug(188U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(194U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 129
{
  ...
  if (&sendAckC$packet[sim_node()] == buf) {
      sendAckC$locked[sim_node()] = FALSE;
      sim_log_debug(154U, "radio_send", "Packet sent...");
      sim_log_debug_clear(155U, "radio_send", " at time %s \n", sim_time_string());

      if (sendAckC$PacketAcknowledgements$wasAcked(&sendAckC$packet[sim_node()]) && TOS_NODE_ID == 1) {
          sendAckC$acks[sim_node()]++;
          sim_log_debug(156U, "ACK", "Packet sent from Mote 1 acknowledged by Mote 2, acks received at Mote 1: %hu\n", sendAckC$acks[sim_node()]);
          if (sendAckC$acks[sim_node()] == sendAckC$last_digit[sim_node()]) {
              sim_log_debug(157U, "timer", "LAST ACK RECEIVED, TIMER STOPPED AT TIME: %s\n", sim_time_string());
              sendAckC$MilliTimer$stop();
            }
        }
      else {
#line 152
        if (sendAckC$PacketAcknowledgements$wasAcked(&sendAckC$packet[sim_node()]) && TOS_NODE_ID == 2) {
            sim_log_debug(158U, "ACK", "Packet sent from mote 2 acknowledged by mote 1\n");

            if (sendAckC$acks[sim_node()] == sendAckC$last_digit[sim_node()]) {
                sendAckC$SplitControl$stop();
              }
          }
        else {
            sim_log_error(159U, "ACK", "Packet sent from mote %hu not acknowledged by mote %hu\n", TOS_NODE_ID == 1 ? 1 : 2, TOS_NODE_ID == 1 ? 2 : 1);
            sendAckC$sendReq();
          }
        }
    }
...
# 140 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
static error_t TossimPacketModelC$PacketAcknowledgements$wasAcked(message_t *ack)
#line 140
{
...
#line 67
  ...
  if (sendAckC$AMSend$send(2, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(148U, "radio_send", "Sending packet of type REQ from Mote 1 to Mote 2");
      sendAckC$locked[sim_node()] = TRUE;
      sim_log_debug_clear(149U, "radio_send", " at time %s \n", sim_time_string());
    }
}
...
#line 101
      sim_log_debug(174U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(175U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(176U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(177U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(195U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(198U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(187U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module sendAckC */
  if (!strcmp(varname, "sendAckC$last_digit"))
  {
    *addr = (uintptr_t)&sendAckC$last_digit[__nesc_mote];
    *size = sizeof(sendAckC$last_digit[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$counter"))
  {
    *addr = (uintptr_t)&sendAckC$counter[__nesc_mote];
    *size = sizeof(sendAckC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$acks"))
  {
    *addr = (uintptr_t)&sendAckC$acks[__nesc_mote];
    *size = sizeof(sendAckC$acks[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$locked"))
  {
    *addr = (uintptr_t)&sendAckC$locked[__nesc_mote];
    *size = sizeof(sendAckC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$packet"))
  {
    *addr = (uintptr_t)&sendAckC$packet[__nesc_mote];
    *size = sizeof(sendAckC$packet[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module sendAckC */
  sendAckC$last_digit[__nesc_mote] = 6;
  sendAckC$counter[__nesc_mote] = 0;
  sendAckC$acks[__nesc_mote] = 0;
  sendAckC$locked[__nesc_mote] = FALSE;
  memset((void *)&sendAckC$packet[__nesc_mote], 0, sizeof sendAckC$packet[__nesc_mote]);
